...
import {BellFilled, CaretDownOutlined, LeftCircleFilled} from '@ant-design/icons';
import "./App.css";
import {Row, Col, Badge, Button, Layout, Menu, Dropdown, message, Descriptions, Table, Input, InputNumber, Popconfirm, Form, Typography} from 'antd';
import { FileDoneOutlined, UserOutlined, CloseOutlined, DownOutlined } from '@ant-design/icons';
...
const Info_screen = () => {
    return (
        <div>
            ...
            />
            <div className="Content" style={{paddingLeft:"120px", paddingRight:"120px", paddingTop:"50px", paddingBottom: '20px', textAlign:'left'}}>
            <Row style={{width:"100%", boxShadow: "rgba(0, 0, 0, 0.1) 0px 0.0625em 0.0625em, rgba(0, 0, 0, 0.1) 0px 0.125em 0.5em, rgba(255, 255, 255, 0.1) 0px 0px 0px 1px inset", height:"50px", marginBottom:'10px', lineHeight : "50px", fontSize:"16px"}}>
                <Col span = {6} style = {{paddingLeft:"20px", color: "#F01836"}}>
                <b>Họ và tên</b>
                </Col>
                <Col span = {18} style = {{color : "#1F468B"}}>
                <b>Nguyễn Trung Phong</b>
                </Col>
            </Row>
            <Row style={{width:"100%", boxShadow: "rgba(0, 0, 0, 0.1) 0px 0.0625em 0.0625em, rgba(0, 0, 0, 0.1) 0px 0.125em 0.5em, rgba(255, 255, 255, 0.1) 0px 0px 0px 1px inset", height:"50px", marginBottom:'10px', lineHeight : "50px", fontSize:"16px"}}>
                <Col span = {6} style = {{paddingLeft:"20px", color: "#F01836"}}>
