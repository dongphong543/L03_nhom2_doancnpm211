...
import {CommentOutlined, FilePdfFilled, VideoCameraFilled, FileFilled,
        FileImageFilled, MinusSquareFilled, PlusSquareFilled } from "@ant-design/icons";
import "./App.css";
...
const Class_content = () => {
    const [lectures, setLectures] = useState([
        ...
        {
            id: 3,
            icon: <VideoCameraFilled style={{ color: "#1F468B", fontSize: "25px" }}/>,
                ...
                {lectures.map((lecture) => (
                    <h3 style={{ 
                        ...
                        <Button
                            ...
                            >
                                {lecture.icon}
                                <span style={{ color: "#2E75A8", fontSize: "17px", marginLeft: "2vw"}}>{lecture.name} </span>
                        </Button> 
                        <Button size="large"
                            type="link"
                            ...
                            <MinusSquareFilled style={{color: "#F01836", fontSize: "20px"}}/>
                        </Button>
                    </h3>
                ))}
                <Button size="large"
            ...
            {tests.map((test) => (
                <h3 style={{ 
                    ...
                    <Button
                        ...
                        >
                            {test.icon}
                            <span style={{ color: "#2E75A8", fontSize: "17px", marginLeft: "2vw"}}>{test.name} </span>
                    </Button> 
                    <Button size="large"
                        type="link"
